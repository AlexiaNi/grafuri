...
int main() {
    ...
    cout << "6. Afiseaza componentele conexe ale graficului" << endl;
    ...
    cout << "17. Verifica daca graful este conex" << endl;
    cout << "18. Verifica daca graful este arbore" << endl;
    cout << "0. Iesire" << endl;
    ...
    case 4: {
        int k;
        cout << "Introduceti nodul pentru care se vor afisa nodurile adiacente: ";
        cin >> k;
